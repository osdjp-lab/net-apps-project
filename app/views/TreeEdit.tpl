...
<form action="{$conf->action_root}treeSave" method="post" class="pure-form pure-form-aligned">
	<fieldset>
		...
		<div class="pure-controls">
			...
			<a class="pure-button button-secondary" href="{$conf->action_root}treeList">Return to tree list</a>
		</div>
	</fieldset>
